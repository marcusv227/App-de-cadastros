...
function App() {
    ...
    <NavigationContainer>
        <Tab.Navigator>
            ...
            <Tab.Screen name="Login" component={Login} options={{headerShown: false, tabBarIcon: ({focused}) => {
                return (<View><IconList name="login" size={24} color={focused? 'blue' : 'grey'}></IconList></View>)
            }}}/>
